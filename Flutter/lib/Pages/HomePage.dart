...
//      body: RaisedButton.icon(onPressed: logoutUser, icon:Icon(Icons.close) , label: Text("Sign Out")),
              ...
              child: ListTile(
                ...
                subtitle: Text(
                  "Joined: " + DateFormat("dd MMMM, yyyy - hh:mm:aa")
                      .format(DateTime.fromMicrosecondsSinceEpoch(int.parse(eachUser.createdAt))),
                  style: TextStyle(
                    color: Colors.grey,
                    fontSize: 14.0,
